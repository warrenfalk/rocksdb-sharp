...
namespace RocksDbSharp
{
    public class WriteBatch : IDisposable, IRocksDbHandle
    {
        ...
        public WriteBatch()
            : this(Native.rocksdb_writebatch_create())
        {
        }

        public WriteBatch(byte[] rep, long size)
            : this(Native.rocksdb_writebatch_create_from(rep, size))
        {
        }
        ...
        public void Dispose()
        {
            ...
            {
                Native.rocksdb_writebatch_destroy(handle);
                handle = IntPtr.Zero;
            }
        }
        ...
        {
            Native.rocksdb_writebatch_clear(handle);
            return this;
        }

        public int Count()
        {
            return Native.rocksdb_writebatch_count(handle);
        }
        ...
        public WriteBatch Put(string key, string val, Encoding encoding = null)
        {
            ...
            Native.rocksdb_writebatch_put(handle, key, val, encoding);
            return this;
        }

        public WriteBatch Put(byte[] key, ulong klen, byte[] val, ulong vlen)
        {
            Native.rocksdb_writebatch_put(handle, key, klen, val, vlen);
            return this;
        }
        ...
        {
            Native.rocksdb_writebatch_put_cf(handle, columnFamily, key, klen, val, vlen);
            return this;
        }
        ...
        {
            Native.rocksdb_writebatch_putv(handle, numKeys, keysList, keysListSizes, numValues, valuesList, valuesListSizes);
            return this;
        }
        ...
        {
            Native.rocksdb_writebatch_putv_cf(handle, columnFamily, numKeys, keysList, keysListSizes, numValues, valuesList, valuesListSizes);
            return this;
        }

        public WriteBatch Merge(byte[] key, ulong klen, byte[] val, ulong vlen)
        {
            Native.rocksdb_writebatch_merge(handle, key, klen, val, vlen);
            return this;
        }
        ...
        {
            Native.rocksdb_writebatch_merge_cf(handle, columnFamily, key, klen, val, vlen);
            return this;
        }
        ...
        {
            Native.rocksdb_writebatch_mergev(handle, numKeys, keysList, keysListSizes, numValues, valuesList, valuesListSizes);
            return this;
        }
        ...
        {
            Native.rocksdb_writebatch_mergev_cf(handle, columnFamily, numKeys, keysList, keysListSizes, numValues, valuesList, valuesListSizes);
            return this;
        }

        public WriteBatch Delete(byte[] key, ulong klen)
        {
            Native.rocksdb_writebatch_delete(handle, key, klen);
            return this;
        }
        ...
        {
            Native.rocksdb_writebatch_delete_cf(handle, columnFamily, key, klen);
            return this;
        }
        ...
        {
            Native.rocksdb_writebatch_deletev(handle, numKeys, keysList, keysListSizes);
            return this;
        }

        public WriteBatch DeletevCf(IntPtr columnFamily, int numKeys, IntPtr keysList, IntPtr keysListSizes)
        {
            Native.rocksdb_writebatch_deletev_cf(handle, columnFamily, numKeys, keysList, keysListSizes);
            return this;
        }

        public WriteBatch PutLogData(byte[] blob, ulong len)
        {
            Native.rocksdb_writebatch_put_log_data(handle, blob, len);
            return this;
        }

        public WriteBatch Iterate(IntPtr state, WriteBatchIteratePutCallback put, WriteBatchIterateDeleteCallback deleted)
        {
            Native.rocksdb_writebatch_iterate(handle, state, put, deleted);
            return this;
        }

        public IntPtr Data(ulong size)
        {
            return Native.rocksdb_writebatch_data(handle, size);
        }
    }
}
